...
class Molecule3DDatasetFragRandomaugDouble(MoleculeDataset):
    ...
    def __init__(self, root, n_mol,choose = 0,transform=None, seed=777,
        ...
        super(Molecule3DDatasetFragRandomaugDouble, self).__init__(
    ...
    def get(self, idx):
        ...
        if self.aug_mode == 'no_aug':
            ...
            first_data = first_augmentations[n_aug](data)
            first_data1 = first_augmentations[n_aug1](data1)
            first_data2 = first_augmentations[n_aug2](data2)

            n_aug = np.random.choice(3,1)[0]
            n_aug1 = np.random.choice(3,1)[0]
            n_aug2 = np.random.choice(3,1)[0]
            second_data = second_augmentations[n_aug](data)
            second_data1 = second_augmentations[n_aug1](data1)
            second_data2 = second_augmentations[n_aug2](data2)            
        else:
            raise ValueError
        return first_data, first_data1, first_data2, second_data, second_data1, second_data2
