...
def mol_fragment(mol):
    ...
    if balanced_rxn == None:
        return None    
    if balanced_rxn[0] == None or balanced_rxn[1] == None:
        return None
    try:
...
class MoleculeDatasetFragRandomaugAny(InMemoryDataset):
    ...
    def __init__(self, root, transform=None, seed=777,
        ...
        super(MoleculeDatasetFragRandomaugAny, self).__init__(
...
if __name__ == '__main__':
    ...
    if args.sum:
        ...
        n_mol = args.n_mol
        root = '{}/molecule_datasets/zinc_standard_agent_any'.format(data_folder)
        ...
        MoleculeDatasetFragRandomaugAny(root=root)
