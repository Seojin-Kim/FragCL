...
class Molecule3DDatasetFragRandomaug(MoleculeDataset):
    ...
    def __init__(self, root, n_mol,choose = 0,transform=None, seed=777,
        ...
        super(Molecule3DDatasetFragRandomaug, self).__init__(
    ...
    def get(self, idx):
        ...
        if self.aug_mode == 'no_aug':
            ...
            two_augmentations = [self.augmentations[self.choose]]
            n_aug = np.random.choice(1,1)[0]
            n_aug1 = np.random.choice(1,1)[0]
            n_aug2 = np.random.choice(1,1)[0]
            data = self.augmentations[n_aug](data.clone())
            data1 = self.augmentations[n_aug1](data1.clone())
            data2 = self.augmentations[n_aug2](data2.clone())
            ...
            if self.choose == 0:
                two_augmentations = [self.augmentations[0], self.augmentations[3], lambda x:x]
            elif self.choose == 1:
            ...
            data = two_augmentations[n_aug](data)
            data1 = two_augmentations[n_aug1](data1)
            data2 = two_augmentations[n_aug2](data2)
        elif self.aug_mode == 'molclr':
            if self.choose == 0:
                two_augmentations = [self.augmentations[0], self.augmentations[3], self.edge_del]
            
            n_aug = np.random.choice(3,1)[0]
            n_aug1 = np.random.choice(3,1)[0]
            n_aug2 = np.random.choice(3,1)[0]
            data = two_augmentations[n_aug](data.clone())
            data1 = two_augmentations[n_aug1](data1.clone())
            data2 = two_augmentations[n_aug2](data2.clone())
...
class Molecule3DDatasetFragRandomaugTrisect(MoleculeDataset):
    ...
    def __init__(self, root, n_mol,choose = 0,transform=None, seed=777,
        ...
        self.augmentations = [self.node_drop, self.subgraph,
                              self.edge_pert, self.attr_mask, lambda x: x]
        super(Molecule3DDatasetFragRandomaugTrisect, self).__init__(
            root, transform, pre_transform, pre_filter)
        ...
        if not empty:
            ...
            self.data1, self.slices1 = torch.load(self.processed_paths[0] + "_1")
            self.data2, self.slices2 = torch.load(self.processed_paths[0] + "_2")
            self.data3, self.slices3 = torch.load(self.processed_paths[0] + "_3")
    ...
    def get(self, idx):
        ...
        for key in self.data1.keys:
            ...
            item3, slices3 = self.data3[key], self.slices3[key]
            s = list(repeat(slice(None), item3.dim()))
            s[data3.__cat_dim__(key, item3)] = slice(slices3[idx], slices3[idx+1])
            data3[key] = item3[s]
        if self.aug_mode == 'no_aug':
            n_aug, n_aug1, n_aug2 = 4, 4, 4
            data = self.augmentations[n_aug](data)
            ...
            n_aug1 = np.random.choice(3,1)[0]
            n_aug2 = np.random.choice(3,1)[0]
            n_aug3 = np.random.choice(3,1)[0]
            data = two_augmentations[n_aug](data)
            data1 = two_augmentations[n_aug1](data1)
            data2 = two_augmentations[n_aug2](data2)
            data3 = two_augmentations[n_aug3](data3)
        elif self.aug_mode == 'molclr':
            if self.choose == 0:
                two_augmentations = [self.augmentations[0], self.augmentations[3], self.edge_del]
