...
class Molecule3DDatasetFragRandomaug3d(MoleculeDataset):
    ...
    def __init__(self, root, n_mol,choose = 0,transform=None, seed=777,
        ...
        super(Molecule3DDatasetFragRandomaug3d, self).__init__(
    ...
    def get(self, idx):
        ...
        if self.aug_mode == 'no_aug':
            ...
            return aug_data, aug_data1, aug_data2, data, data1, data2
